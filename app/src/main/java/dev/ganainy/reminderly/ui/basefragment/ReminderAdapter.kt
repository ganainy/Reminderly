...
import dev.ganainy.reminderly.databinding.HeaderItemBinding
import dev.ganainy.reminderly.databinding.NativeAdBinding
import dev.ganainy.reminderly.databinding.ReminderItemBinding
            ...
            val adLoader: AdLoader = AdLoader.Builder(
               ...
               context.getString(R.string.admob_native_unit_id)
                ...
                .forUnifiedNativeAd { unifiedNativeAd ->
                    ...
                    val styles =
                        dev.google.android.ads.nativetemplates.NativeTemplateStyle.Builder().withMainBackgroundColor(ColorDrawable(0xfff))
                            .build()
